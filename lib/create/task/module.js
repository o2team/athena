...
var MModule = Base.extend({
  ...
  write: function (cb) {
    ...
    this.copy(appConf.tmpName || 'default','module' ,'_module-conf.js', conf.moduleName + '/module-conf.js');
    this.copy(appConf.tmpName || 'default','module' ,'_static-conf.js', conf.moduleName + '/static-conf.js');
