...
var Widget = Base.extend({
  ...
  write: function (cb) {
    ...
    this.copy('widget','widget.html', 'widget/' + widgetName + '/' + widgetName + '.html');
    ...
    this.copy('widget','widget.css', cssFileName);
    this.copy('widget','widget.js', 'widget/' + widgetName + '/' + widgetName + '.js');
    this.copy('widget','widget.json', 'widget/' + widgetName + '/' + widgetName + '.json');
