...
var Widget = Base.extend({
  ...
  write: function (cb) {
    ...
    this.copy(this.moduleConf.tmpId , 'widget','widget.html', 'widget/' + widgetName + '/' + widgetName + '.html');
    ...
    this.copy(this.moduleConf.tmpId , 'widget','widget.css', cssFileName);
    this.copy(this.moduleConf.tmpId , 'widget','widget.js', 'widget/' + widgetName + '/' + widgetName + '.js');
    this.copy(this.moduleConf.tmpId , 'widget','widget.json', 'widget/' + widgetName + '/' + widgetName + '.json');
