...
var App = Base.extend({
  ...
  talk: function (cb , opts) {
    ...
    opts.templatesinfo.templates.forEach(function(o,i){
      tmpchoices.push({
        name : o.name,
        value: o.name
      })
    ...
    inquirer.prompt(prompts, function (answers) {
      ...
      answers.templateName = answers.templateName || conf.template;
      if (conf.sass) {
  ...
  write: function (options, cb) {
    ...
    this.copy(options.templateName ,'app', '_gb.css', commonModule + '/page/gb/gb.css');
    this.copy(options.templateName ,'app', '_gb.js', commonModule + '/page/gb/gb.js');
    this.copy(options.templateName ,'app', '_gb.html', commonModule + '/page/gb/gb.html');
    if (conf.cssPretreatment === 'sass') {
      this.copy(options.templateName ,'app', '_common.scss', commonModule + '/static/sass/_common.scss');
    }
    this.copy(options.templateName ,'app', '_module-conf.js', commonModule + '/module-conf.js');
    this.copy(options.templateName ,'app', '_static-conf.js', commonModule + '/static-conf.js');

    this.copy(options.templateName ,'app', '_app-conf.js', conf.appName + '/app-conf.js');
    this.copy(options.templateName ,'app', 'editorconfig', conf.appName + '/.editorconfig');
