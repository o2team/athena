...
var App = Base.extend({
  ...
  write: function (options, cb) {
    ...
    this.copy({tmpid:options.tmpId}, 'app', '_gb.css', commonModule + '/page/gb/gb.css');
    this.copy({tmpid:options.tmpId}, 'app', '_gb.js', commonModule + '/page/gb/gb.js');
    this.copy({tmpid:options.tmpId}, 'app', '_gb.html', commonModule + '/page/gb/gb.html');
    if (conf.cssPretreatment === 'sass') {
      this.copy({tmpid:options.tmpId}, 'app', '_common.scss', commonModule + '/static/sass/_common.scss');
    }
    this.copy({tmpid:options.tmpId}, 'app', '_module-conf.js', commonModule + '/module-conf.js');
    this.copy({tmpid:options.tmpId}, 'app', '_static-conf.js', commonModule + '/static-conf.js');

    this.copy({tmpid:options.tmpId}, 'app', '_app-conf.js', conf.appName + '/app-conf.js');
    this.copy({tmpid:options.tmpId}, 'app', 'editorconfig', conf.appName + '/.editorconfig');
