            ...
            if (!pageInclude) {
              ...
              for (var i = 0; i < cssFiles.length; i++) {
                ...
                if (cssModuleName === moduleConf.module) {
                  ...
                  cssHashName = athenaMate.comboHelper.getHashName(cssName + '.css', mapJson);
                  cssMinHashName = athenaMate.comboHelper.getHashName(cssName + '.min.css', mapJson);
              ...
              for (var i = 0; i < jsFiles.length; i++) {
                ...
                if (jsModuleName === moduleConf.module) {
                  jsHashName = athenaMate.comboHelper.getHashName(jsName, mapJson);
          ...
          vfs.src(globPages, { base: modulePath + '/dist/output' })
            ...
            .pipe($.util.noop()).on('finish', function (err) {
              ...
              vfs.src(htmlPathList)
                .pipe(athenaMate.comboHelper.combo({
                  app: moduleConf.app,
                  module: moduleConf.module,
                  cwd: appPath,
