            ...
            if (!pageInclude) {
              ...
              for (var i = 0; i < cssFiles.length; i++) {
                ...
                if (cssModuleName === moduleConf.module) {
                  ...
                  cssHashName = Util.getHashName('css/' + cssName + '.css', mapJson);
                  globPages.push(dpath + 'css/' + cssName + '.*');
                  globPages.push(dpath + cssHashName);
                }
              }
              ...
              for (var i = 0; i < jsFiles.length; i++) {
                ...
                if (jsModuleName === moduleConf.module) {
                  jsHashName = Util.getHashName('js/' + jsName, mapJson);
                  jsName = path.basename(jsName, '.js');
                  globPages.push(dpath + 'js/' + jsName + '.*');
                  globPages.push(dpath + jsHashName);
                }
              }
            }
            if (useShtml) {
