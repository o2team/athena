...
module.exports = function ($, appConf, moduleConf, args) {
  return function (mod, modulePath, appPath) {
    return new Promise(function (resolve, reject) {
      ...
      var useShtml = appConf.useShtml ? appConf.useShtml : false;
      ...
      function generateTemp () {
        ...
        for (var k = 0; k < folders.length; k++) {
          var modConf = require(path.join(appPath, folders[k], 'module-conf'));
          ...
          .on('end', function () {
            ...
            if (remoteName !== 'local' && remoteName !== 'preview') {
              ...
              vfs.src(path.join(modulePath, 'dist', 'output', '*.html'))
                .pipe(athenaMate.if(useShtml, athenaMate.combo({
                  app: moduleConf.app,
                  module: moduleConf.module,
                  cwd: appPath,
